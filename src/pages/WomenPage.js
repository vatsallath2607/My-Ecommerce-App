...
function WomenPage({ onAddToCart, category }) {
  ...
  const womenProducts = allProducts.filter(product => product.category === category);

  return (
    <div>
      <h1>Women's Collection</h1>
      <ProductList products={womenProducts} onAddToCart={onAddToCart} />
    </div>
  );
}
