...
function MenPage({ onAddToCart, category }) {
  ...
  const menProducts = allProducts.filter(product => product.category === category);

  return (
    <div>
      <h1>Men's Collection</h1>
      <ProductList products={menProducts} onAddToCart={onAddToCart} />
    </div>
  );
}
